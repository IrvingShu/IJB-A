clear all;
clc;
img_data_path = '\data\IJB-A\IJB-A_images';
meta_path = '\data\IJB-A\IJB-A_11_sets';
save_path = '\data\IJB-A\IJB-A_11_face_images';
list_path = '\data\IJB-A\IJB-A_11_face_images';
